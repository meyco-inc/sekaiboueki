	...
	<section class="history about__conts">
		<div class="container">
			<div class="inner">
				...
				<p class="business__lead scroll-up">地域に根付いて、企業様の快適な仕事を<br class="sp">支える縁の下の力持ちへ。</p>
			</div>
			<div class="history__wrap">
				...
				<div class="history__year__wrap history__2021 scroll-up">
					<h3>2021</h3>
					<div class="history__text__wrap">
				...
				<div class="history__year__wrap history__2026 scroll-up">
					<h3>2026</h3>
					<div class="history__text__wrap">
				...
				<div class="history__year__wrap history__2027 scroll-up">
					<h3>2027</h3>
					<div class="history__text__wrap">

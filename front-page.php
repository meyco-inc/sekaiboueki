...
<main class="top-page">
	...
	<section id="top" class="mv top scroll">
		<div id="top__slideshow" class="top__slideshow">
			...
			<img src="<?php echo get_template_directory_uri(); ?>/img/top/mv_top_2.jpg" alt="">
			<img src="<?php echo get_template_directory_uri(); ?>/img/top/mv_top_3.jpg" alt="">
	...
	<section id="member" class="mv member scroll">
		...
		<div class="memberPic__outer">
			<img src="<?php echo get_template_directory_uri(); ?>/img/top/mv_member2.png" alt="" class="mv__member__img">
			<div class="top-inner">
		...
		<div class="top-inner">
			<div class="text-inner">
				...
				<a href="#top" class="return_top">
					<p>RETURN TOP<span>トップへ戻る</span></p>
				</a>
			</div>
		</div>
	</section>

		...
		<div class="header__fix">
			<div class="container header__inner">
				...
				<div class="header_right">
					<a href="<?php echo home_url(); ?>/entry" class="pc"><img src="<?php echo get_template_directory_uri(); ?>/img/top/entry.jpg" alt="2022 Entry" class="header__entry"></a>
					<?php if ( is_home() || is_front_page() ) :?>
					...
					<nav class="nav" id="nav">
						<div class="top-inner">
							...
							<a href="<?php echo home_url(); ?>/entry" class="sp"><img src="<?php echo get_template_directory_uri(); ?>/img/top/entry.jpg" alt="2022 Entry" class="header__entry nav__entry"></a>
